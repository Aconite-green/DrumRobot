...
void StateTask::homeModeLoop()
{
    ...
    while (systemState.main == Main::Homing)
    {
        ...
        vector<vector<string>> PriorityTMotorNames = {{"L_arm1", "R_arm1"}, {"L_arm2", "R_arm2"}, {"L_arm3", "R_arm3"}};
...
void StateTask::SetTmotorHome(vector<std::shared_ptr<GenericMotor>> &motors, vector<std::string> &motorNames)
{
...
void StateTask::HomeTMotor(vector<std::shared_ptr<GenericMotor>> &motors, vector<std::string> &motorNames)
...
vector<float> StateTask::MoveTMotorToSensorLocation(vector<std::shared_ptr<GenericMotor>> &motors, vector<std::string> &motorNames, vector<int> &sensorsBit)
{
    struct can_frame frameToProcess;
    vector<shared_ptr<TMotor>> tMotors;
...
void StateTask::RotateTMotor(vector<std::shared_ptr<GenericMotor>> &motors, vector<std::string> &motorNames, vector<double> &directions, vector<double> &degrees, vector<float> &midpoints)
{
...
void StateTask::SetMaxonHome(vector<std::shared_ptr<GenericMotor>> &motors, vector<std::string> &motorNames)
{
    struct can_frame frame;
